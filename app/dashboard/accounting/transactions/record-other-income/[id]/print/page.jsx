...
export default function IncomeVoucherPrintPage() {
  ...
  if (isLoading) return <div className="p-8">Loading income voucher...</div>;
  ...
  return (
    <div className="p-8 print:p-0 max-w-2xl mx-auto bg-white print:bg-white">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold mb-2">Income Voucher</h1>
      ...
      <div className="mt-12 flex justify-between print:hidden">
        ...
        <a href="/dashboard/accounting/transactions/record-other-income" className="text-blue-600 underline">Back to List</a>
      </div>
    </div>
  );
} 
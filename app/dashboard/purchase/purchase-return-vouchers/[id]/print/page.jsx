...
export default function PurchaseReturnPrintPage() {
  ...
  const { supplier, returnNumber, date, referenceNo, currency, items: voucherItems, totalAmount, status } = voucher;
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 32, fontFamily: 'sans-serif', color: '#222' }}>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 16 }}>Purchase Return Voucher</h1>

...
export default function PurchaseBillPrintPage() {
  ...
  const { supplier, purchaseOrderNumber, date, dueDate, referenceNo, currency, items: billItems, totalAmount, status } = bill;
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 32, fontFamily: 'sans-serif', color: '#222' }}>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 16 }}>Purchase Bill</h1>
      <div style={{ marginBottom: 16 }}>
        <div><b>Order Number:</b> {purchaseOrderNumber || 'N/A'}</div>
        ...
        <div><b>Supplier:</b> {typeof supplier === 'object' ? supplier?.name : supplier}</div>
      </div>

...
const SalesVoucher = mongoose.models.SalesVoucher || mongoose.model('SalesVoucher', salesVoucherSchema);
...
const salesBillSchema = new mongoose.Schema({
  ...
  salesVoucher: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'SalesVoucher', // Optional reference to a SalesVoucher
  },
  referenceNo: {
...
export { 
  ...
  PurchaseBill, Customer, SalesVoucher, SalesBill, SalesReturnVoucher, 

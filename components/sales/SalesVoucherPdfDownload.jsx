...
export default function SalesVoucherPdfDownload({ salesOrder, children }) {
  const generatePdf = (order) => {
    ...
    // Order Info
    doc.text(`Order No: ${order.salesOrderNumber || 'N/A'}`, 150, 32);
    ...
    doc.text('Total Discount:', 150, finalY + 7);
    ...
    if (order.isExport && order.currency !== 'NPR') {
      ...
      doc.text('Equivalent in NPR:', 150, finalY + 28);
